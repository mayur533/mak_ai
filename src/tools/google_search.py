...
class GoogleSearchTool:
    ...
    def __init__(self):
        ...
        if not self.search_api_key:
            self.logger.warning("Google Search requires Gemini API key. Set GEMINI_API_KEY in .env")
    
    def search(self, query: str, num_results: int = 10, safe_search: str = "moderate") -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if 'candidates' in data and data['candidates']:
                ...
                text_with_citations = self._add_inline_citations(search_result, grounding_supports, grounding_chunks)
    ...
    def search_images(self, query: str, num_results: int = 10) -> Dict[str, Any]:
        ...
        if not self.search_api_key:
            return {
                "success": False,
                "error": "Google Search requires Gemini API key"
            }
...
"""
    ...
    def _add_inline_citations(self, text: str, grounding_supports: List[Dict], grounding_chunks: List[Dict]) -> str:
        """
