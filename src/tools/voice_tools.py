...
class VoiceTools:
    ...
    def __init__(self, system=None):
        ...
        if self.voice_enabled:
            ...
            self.logger.warning(
                "Voice tools not available - dependencies not installed or disabled"
            )
    ...
    def convert_audio_format(
        self, input_file: str, output_file: str, output_format: str = "wav"
    ) -> Dict[str, Any]:
        """
    ...
    def test_voice_system(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": f"Voice system test failed: {e}"}
