        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                """, (
                    ...
                    json.dumps(list(entry.tags), default=str),
                    entry.source,
                    entry.duration,
                    entry.success,
                    entry.tokens_used,
                    entry.memory_impact,
                    json.dumps(entry.related_entries, default=str),
                    entry.compressed,
                    entry.version,
                    embedding_blob,
                    entry.semantic_hash,
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                """, (
                    ...
                    session.is_active,
                    json.dumps(session.session_metadata, default=str),
                    json.dumps(session.performance_metrics, default=str),
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                """, (
                    ...
                    note["title"],
                    note["content"],
                    json.dumps(note["tags"], default=str),
                    note["importance"],
                    note["created_at"],
                    note["last_accessed"],
                    note["access_count"]
