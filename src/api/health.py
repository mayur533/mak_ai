...
class HealthHandler(BaseHTTPRequestHandler):
    ...
    def _handle_ready(self):
        ...
        ready_checks = {
            ...
            'context_manager_ready': hasattr(self.ai_system, 'context_manager') if self.ai_system else False,
            'tool_manager_ready': hasattr(self.ai_system, 'tool_manager') if self.ai_system else False,
            'gemini_client_ready': hasattr(self.ai_system, 'gemini_client') if self.ai_system else False
        }
...
class HealthServer:
    ...
    def start(self):
        ...
        try:
            ...
            handler = lambda *args, **kwargs: HealthHandler(self.ai_system, *args, **kwargs)
...
def start_health_server(ai_system, host: str = 'localhost', port: int = 8000) -> HealthServer:
